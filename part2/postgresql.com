...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2022-04-19T03:52:37.917770" />
  ...
  <link href="/media/css/fontawesome.css?d8c24ae4" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?d8c24ae4">
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pg_partman-461-released-2440/">pg_partman 4.6.1 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-04-18 by Crunchy Data</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-jdbc-4234-released-2439/">PostgreSQL JDBC 42.3.4 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-04-18 by JDBC Project</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/version-200-of-advanced-postgresql-driver-written-in-c-2436/">Version 2.0.0 of advanced PostgreSQL driver written in C++</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-04-13 by Dmitry Igrishin</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgbadger-v118-released-2434/">pgBadger v11.8 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-04-12 by MigOps</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pg_dbms_job-v120-released-2435/">pg_dbms_job v1.2.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-04-12 by MigOps</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5jL"> Bharath Rupireddy</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Andreas &#x27;ads&#x27; Scherbaum</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-04-18</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5jJ"> Orafce 3.21.0</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Pavel Stehule</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-04-16</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5jI"> pgBackRest multi-repositories tips and tricks</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Stefan Fercot</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-04-15</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5jH"> pg_ivm: a PostgreSQL extension providing Incremental View Maintenance feature</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Yugo Nagata</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-04-15</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5jG"> Formatting SQL code with pgFormatter within Emacs</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Luca Ferrari</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-04-13</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5jC"> Stop the war in Ukraine</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hubert &#x27;depesz&#x27; Lubaczewski</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-04-12</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5jB"> Multiranges in PostgreSQL 14</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5jF"> Missing metrics required to gain visibility into Postgres performance</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5jA"> PostGIS For Newbies</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Elizabeth Garrett Christensen</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-04-11</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?d8c24ae4"></script>
